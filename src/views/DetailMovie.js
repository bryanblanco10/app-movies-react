            ...
            <div className="movie-img sticky-sb">
              ...
              <div className="movie-btn">
                <div className="btn-transform transform-vertical red">
                  <div>
                    <a href="b" className="item item-1 redbtn">
                      {" "}
                ...
                <div className="btn-transform transform-vertical">
                  <div>
                    <a href="b" className="item item-1 yellowbtn">
                      {" "}
                      <i className="ion-card"></i> Buy ticket
                    </a>
                  </div>
                  <div>
                    <a href="b" className="item item-2 yellowbtn">
                      ...
                      <div className="row">
                        <div className="col-md-8 col-sm-12 col-xs-12">
                          ...
                          <div className="mv-user-review-item">
                            ...
                            <p className="time">
                              17 December 2016 by <a href="b"> hawaiipierson</a>
                            </p>
                            <p>
                        ...
                        <div className="col-md-4 col-xs-12 col-sm-12">
                          ...
                          <div className="sb-it">
                            <h6>Genres:</h6>
                            <p>
                              <a href="b">Action, </a> <a href="b"> Sci-Fi,</a>{" "}
                              <a href="b">Adventure</a>
                            </p>
                          </div>
                          <div className="sb-it">
                            <h6>Release Date:</h6>
                          ...
                          <div className="sb-it">
                            ...
                            <p className="tags">
                              <span className="time">
                                <a href="b">superhero</a>
                              </span>
                              <span className="time">
                                <a href="b">marvel universe</a>
                              </span>
                              <span className="time">
                                <a href="b">comic</a>
                              </span>
                              <span className="time">
                                <a href="b">blockbuster</a>
                              </span>
                              <span className="time">
                                <a href="b">final battle</a>
                              </span>
                            </p>
                          </div>
                          <div className="ads">
                        ...
                        <div className="mv-user-review-item ">
                          <div className="user-infor">
                            ...
                            <div>
                              ...
                              <p className="time">
                                26 March 2017 by <a href="b"> juliawest</a>
                              </p>
                            </div>
                          </div>
                          <p>
                          ...
                          <p>
                            ...
                            in that classNameic Star Trek prime story. Wouldst
                        ...
                        <div className="mv-user-review-item last">
                          <div className="user-infor">
                            ...
                            <div>
                              ...
                              <p className="time">
                                26 March 2017 by <a href="b"> johnnylee</a>
                              </p>
                            </div>
                          </div>
                          <p>
                        ...
                        <div className="mvsingle-item media-item">
                          <div className="vd-item">
                            ...
                            <div className="vd-infor">
                              <h6>
                                {" "}
                                <a href="b">Trailer: Watch New Scenes</a>
                              </h6>
                          ...
                          <div className="vd-item">
                            ...
                            <div className="vd-infor">
                              <h6>
                                {" "}
                                <a href="b">Interview: Robert Downey Jr</a>
                              </h6>
                          ...
                          <div className="vd-item">
                            ...
                            <div className="vd-infor">
                              <h6>
                                {" "}
                                <a href="b">Interview: Scarlett Johansson</a>
                              </h6>
                              <p className="time"> 3:27</p>
                            </div>
                          </div>
                          ...
                          <div className="vd-item">
                            ...
                            <div className="vd-infor">
                              <h6>
                                {" "}
                                <a href="b">Interview: Director Joss Whedon</a>
                              </h6>
                              <p className="time"> 1: 03</p>
                            </div>
                          </div>
                          <div className="vd-item">
                            ...
                            <div className="vd-infor">
                              <h6>
                                {" "}
                                <a href="b">Interview: Mark Ruffalo</a>
                              </h6>
                              <p className="time"> 3:27</p>
                            </div>
                          </div>
                      ...
                      <div className="row">
                        ...
                        <div className="movie-item-style-2">
                          ...
                          <div className="mv-item-infor">
                            ...
                            <p>
                              Director: <a href="b">Joss Whedon</a>
                            </p>
                            <p>
                              Stars: <a href="b">Robert Downey Jr.,</a>{" "}
                              <a href="b">Chris Evans,</a>{" "}
                              <a href="b"> Chris Hemsworth</a>
                            </p>
                          </div>
                        ...
                        <div className="movie-item-style-2">
                          ...
                          <div className="mv-item-infor">
                            ...
                            <p>
                              Director: <a href="b">Anthony Russo,</a>
                              <a href="b">Joe Russo</a>
                            </p>
                            <p>
                              Stars: <a href="b">Chris Evans,</a>{" "}
                              <a href="b">Samuel L. Jackson,</a>{" "}
                              <a href="b"> Scarlett Johansson</a>
                            </p>
                          </div>
                        </div>
                        <div className="movie-item-style-2">
                          ...
                          <div className="mv-item-infor">
                            ...
                            <p>
                              Director: <a href="b">Peyton Reed</a>
                            </p>
                            <p>
                              Stars: <a href="b">Paul Rudd,</a>{" "}
                              <a href="b"> Michael Douglas</a>
                            </p>
                          </div>
                        </div>
                        <div className="movie-item-style-2">
                          ...
                          <div className="mv-item-infor">
                            ...
                            <p>
                              Director: <a href="b">Shane Black</a>
                            </p>
                            <p>
                              Stars: <a href="b">Robert Downey Jr., </a>{" "}
                              <a href="b"> Guy Pearce,</a>
                              <a href="b">Don Cheadle</a>
                            </p>
                          </div>
                        </div>
                        <div className="movie-item-style-2">
                          ...
                          <div className="mv-item-infor">
                            ...
                            <p>
                              Director: <a href="b">Alan Taylor</a>
                            </p>
                            <p>
                              Stars: <a href="b">Chris Hemsworth, </a>{" "}
                              <a href="b"> Natalie Portman,</a>
                              <a href="b">Tom Hiddleston</a>
                            </p>
                          </div>
                        </div>
                        <div className="topbar-filter">
